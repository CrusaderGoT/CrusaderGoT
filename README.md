...
I build things for the web — full-stack, end-to-end, from database schema to UI interaction.
When I'm not shipping code, I'm writing fiction or reading it.
...
- 🛠 Self-taught full-stack developer based in **Ibadan, Nigeria**
- 🎓 B.Sc. Information Technology — Federal University of Technology Owerri
- 🌐 I work across the entire stack — REST APIs, databases, server actions, service workers, the whole thing
- ✍️ Author of web fiction published at [achebestan.vercel.app](https://achebestan.vercel.app)
- 📖 Currently reading *A Song of Ice and Fire*
- 🌸 Learning Japanese — slowly, steadily
- 🔁 Open-source contributor — merged into [next-safe-action](https://github.com/TheEdoRan/next-safe-action)
...
![next-safe-action](https://img.shields.io/badge/next--safe--action-black?style=flat-square&logoColor=white)
![Better Auth](https://img.shields.io/badge/better--auth-black?style=flat-square&logoColor=white)
![Redis](https://img.shields.io/badge/Redis-dc382d?style=flat-square&logo=redis&logoColor=white)
![Socket.io](https://img.shields.io/badge/Socket.io-010101?style=flat-square&logo=socket.io&logoColor=white)
![Serwist](https://img.shields.io/badge/Serwist-PWA-8b5cf6?style=flat-square&logoColor=white)
...
|---|---|---|
| [**The Culling Game**](https://github.com/CrusaderGoT/The-Culling-Game) | Full-stack multiplayer game platform with 530+ commits. Players register, build cursed techniques, join colonies, and compete through a community voting system. | FastAPI · PostgreSQL · Next.js |
| [**Achebestan**](https://achebestan.vercel.app) | A web fiction reading platform — clean, fast, offline-capable. Home to original serialized fiction. | Next.js · Drizzle · Mantine |
